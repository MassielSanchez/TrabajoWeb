    ...
    div.innerHTML = `
        <div class="info-carrera-contenido">
            <div class="info-texto">
                <div class="info-seccion-bloque"> <p class="carrera-descripcion-corta">${info.descripcion || ''}</p>
                </div>
                
                <div class="info-seccion-bloque"> <p class="descripcion-larga">${info.descripcionLarga}</p>
                </div>
                ...
                <div class="titulos-otorgados info-seccion-bloque"> <h4>🎓 Títulos que otorgamos:</h4>
                    <ul>
                ...
                <div class="duracion-bloque"> <p><strong>⏱️ Duración:</strong> ${info.duracion}</p>
                </div>
